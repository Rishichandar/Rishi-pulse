...
const Admin = () => {
  ...
  const fetchData1 = async () => {
    try {
      const response = await fetch("http://192.168.0.135:4445/project_info");
  ...
  const fetchData2 = async () => {
    try {
      const response = await fetch("http://192.168.0.135:4445/project_info1");
      const jsonData = await response.json();
  ...
  const handleSoftDelete = async (Projectid, index) => {
    try {
      await axios.put(
        `http://192.168.0.135:4445/api/project_info/delete/${Projectid}`
      );
  ...
  const cancelSoftDelete = async (Projectid, index) => {
    try {
      await axios.put(
        `http://192.168.0.135:4445/api/project_info/canceldelete/${Projectid}`
      );
      const newActivationStates = [...activationStates];
...
//     const handleSoftDelete = async (Projectid, index) => {
//         try {
//             await axios.put(`http://192.168.0.135:4445/api/project_info/delete/${Projectid}`);
//             const newActivationStates = [...activationStates];
//             newActivationStates[index] = false;
//             setActivationStates(newActivationStates);
//         } catch (error) {
...
//     const cancelSoftDelete = async (Projectid, index) => {
//         try {
//             await axios.put(`http://192.168.0.135:4445/api/project_info/canceldelete/${Projectid}`);
//             const newActivationStates = [...activationStates];
//             newActivationStates[index] = true;
//             setActivationStates(newActivationStates);
//         } catch (error) {
...
//     const searchProject = async () => {
//         try {
//             const response = await fetch(`http://192.168.0.135:4445/project_info1/title/${projectTitle}`);
//             if (!response.ok) {
//                 throw new Error("Failed to fetch");
//             }
//             const ans = await response.json();
