...
//   setSubmitted(true);
//   axios.post('http://localhost:4023/project_infos', inputValue)//inside we write api to post the data in mysql
//   .then(res=> console.log(res))
//   .catch(err=> console.log(err));
            ...
            <div id='form'>
              ...
              <tr>
                <TextField
                  ...
                  name="Title"
                  id="title"
                  sx={{ width: "300px", mb: 5, position: 'relative', top: 30}}
                  InputLabelProps={{ style: { fontSize: '13px', fontFamily: "'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif" } }}
                  onChange={handleChange}
                  onFocus={handleFocus}
                  onBlur={handleBlur}
                ...
                <TextField
                  ...
                  disabled
                  id='email'
                  style={{ position: 'relative', bottom: -30,left:30, fontSize: '12' }}
                  InputLabelProps={{ style: { fontSize: '15px', fontFamily: "'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif"  } }}
                  label="Email"
                />
              </tr>
              <tr>
                <TextField
                  ...
                  autoFocus
                  name="Description"
                  sx={{ width: "300px", mb: 5, position: 'relative', top: 45 }}
                  onChange={handleChange}
                  id='description'
                  InputLabelProps={{ style: { fontSize: '13px', fontFamily: "'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif"  } }}
                  onFocus={handleFocus}
                  ...
                  label={isFocused ? "Description *" : "Description"}
                />
                <FormControl sx={{ m: 1, width: 300, position: 'relative', bottom: -35, right: -20 }}>
                  <InputLabel 
                    id="demo-multiple-name-label" 
                    style={{ fontSize: '14px' }}
                  >
              ...
              <tr>
                <input type='date' id='startdate' name='Startdate' onChange={handleChange} style={{width:"300px",textAlign:"center",height:"50px",color:"white",position: 'relative', bottom:"-65px"}}/>
           
           
                <input type='date' id='enddate' name='Deadline' onChange={handleChange} style={{width:"300px",textAlign:"center",height:"50px",color:"white",position: 'relative', bottom:"-65px",left:'30px'}}/>
              </tr>
              <tr>
                <TextField
                  type="Tools"
                  ...
                  onChange={handleChange}
                  id='tool'
                  style={{ marginTop: '15px', position: 'relative', top: 125,left: 170 }}
                  InputLabelProps={{ style: { fontSize: '13px', fontFamily: "'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif"  } }}
                  onFocus={handleFocus}
                  onBlur={handleBlur}
                  label={isFocused ? "Tech stack *" : "Teck stack"}
